...
import org.tdcoinj.store.SPVBlockStore;
...
public final class Constants {
    ...
    /** Tdcoinj global context. */
    public static final Context CONTEXT = new Context(NETWORK_PARAMETERS);

    /**
     * The type of Tdcoin addresses used for the initial wallet: {@link Script.ScriptType#P2PKH} for classic
    ...
    /**
     * The type of Tdcoin addresses to upgrade the current wallet to: {@link Script.ScriptType#P2PKH} for classic
     * Base58, {@link Script.ScriptType#P2WPKH} for segwit Bech32.
     */
    ...
    public final static class Files {
        ...
        public static final String EXTERNAL_WALLET_BACKUP = "tdcoin-wallet-backup" + FILENAME_NETWORK_SUFFIX;
    ...
    public static final HttpUrl VERSION_URL = HttpUrl.parse("https://www.tdcoincore.org/version"
            + (NETWORK_PARAMETERS.getId().equals(NetworkParameters.ID_MAINNET) ? "" : "-test"));
    /** URL to fetch dynamic fees from. */
    public static final HttpUrl DYNAMIC_FEES_URL = HttpUrl.parse("https://www.tdcoincore.org/fees");

    /** MIME type used for transmitting single transactions. */
    public static final String MIMETYPE_TRANSACTION = "application/x-tdctx";

    /** MIME type used for transmitting wallet backups. */
    public static final String MIMETYPE_WALLET_BACKUP = "application/x-tdcoin-wallet-backup";

    /** Number of confirmations until a transaction is fully confirmed. */
    public static final int MAX_NUM_CONFIRMATIONS = 6;

    /** User-agent to use for network access. */
    public static final String USER_AGENT = "Tdcoin Wallet";
    ...
    public static final String DONATION_ADDRESS = NETWORK_PARAMETERS.getId().equals(NetworkParameters.ID_MAINNET)
            ? "TXTLcoCQmu5e1aX23YhHtHy6s4P23XwxJz" : null;

    /** Recipient e-mail address for reports. */
    public static final String REPORT_EMAIL = "tdcoin.wallet.developers@itservicefl.com";
    ...
    public static final Coin TOO_MUCH_BALANCE_THRESHOLD = Coin.COIN.multiply(100);//divide(1); //TDCOIN
