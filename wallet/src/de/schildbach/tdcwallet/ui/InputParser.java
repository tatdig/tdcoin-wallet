...
import org.tdcoinj.core.DumpedPrivateKey;
import org.tdcoinj.core.LegacyAddress;
import org.tdcoinj.core.PrefixedChecksummedBytes;
import org.tdcoinj.core.ProtocolException;
import org.tdcoinj.core.Transaction;
import org.tdcoinj.core.VerificationException;
import org.tdcoinj.crypto.BIP38PrivateKey;
import org.tdcoinj.crypto.TrustStoreLoader;
import org.tdcoinj.protocols.payments.PaymentProtocol;
import org.tdcoinj.protocols.payments.PaymentProtocol.PkiVerificationData;
import org.tdcoinj.protocols.payments.PaymentProtocolException;
import org.tdcoinj.protocols.payments.PaymentSession;
import org.tdcoinj.uri.TdcoinURI;
import org.tdcoinj.uri.TdcoinURIParseException;
        ...
        public void parse() {
            if (input.startsWith("BITCOIN:-")) {
                ...
                try {
                    ...
                    handlePaymentIntent(PaymentIntent.fromTdcoinUri(tdcoinUri));
                } catch (final TdcoinURIParseException x) {
                    log.info("got invalid tdcoin uri: '" + input + "'", x);

                    error(R.string.input_parser_invalid_tdcoin_uri, input);
                }
