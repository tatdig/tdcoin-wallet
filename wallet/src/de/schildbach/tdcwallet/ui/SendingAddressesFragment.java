...
public final class SendingAddressesFragment extends FancyListFragment {
        ...
        activity.startActionMode(new ActionMode.Callback() {
            ...
            public boolean onActionItemClicked(final ActionMode mode, final MenuItem item) {
                ...
                case R.id.sending_addresses_context_show_qr:
                    final String uri = TdcoinURI.convertToTdcoinURI(Constants.NETWORK_PARAMETERS,
    ...
    private void handleCopyToClipboard(final String address) {
        viewModel.clip.setClipData(ClipData.newPlainText("Tdcoin address", address));
    ...
    private Address getAddressFromPrimaryClip() {
        ...
        if (clipDescription.hasMimeType(ClipDescription.MIMETYPE_TEXT_PLAIN)) {
            ...
            if (clipUri == null)
                return null;
            try {
                return new TdcoinURI(clipUri.toString()).getAddress();
