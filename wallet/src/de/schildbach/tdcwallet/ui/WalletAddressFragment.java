...
public final class WalletAddressFragment extends Fragment {
    ...
    public void onCreate(final Bundle savedInstanceState) {
        ...
        viewModel.tdcoinUri.observe(this, new Observer<Uri>() {
            ...
            public void onChanged(final Uri tdcoinUri) {
                ...
                if (nfcAdapter != null)
                    nfcAdapter.setNdefPushMessage(createNdefMessage(tdcoinUri.toString()), activity);
    ...
    public View onCreateView(final LayoutInflater inflater, final ViewGroup container,
        ...
        currentAddressQrView = (ImageView) view.findViewById(R.id.tdcoin_address_qr);

        currentAddressQrCardView = (CardView) view.findViewById(R.id.tdcoin_address_qr_card);
