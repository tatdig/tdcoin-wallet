...
public class CryptoTest {
    ...
    public void backups() throws Exception {
        final byte[] backup = Crypto.decryptBytes(readBackupFromResource("tdcoin-wallet-backup-2019-06-26"),
                PASSWORD);
        assertTrue(WalletProtobufSerializer.isWallet(new ByteArrayInputStream(backup)));

        final byte[] backupCrLf = Crypto.decryptBytes(readBackupFromResource("tdcoin-wallet-backup-testnet-3.50-crlf"),
                PASSWORD);
